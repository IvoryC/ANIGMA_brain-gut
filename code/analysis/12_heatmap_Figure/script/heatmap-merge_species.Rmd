...
diversity = read.delim2(file.path(div.vs.feat.module, "output/species/bigList_pvalues_fdr-adjusted_species.txt"))
...
taxa = read.delim2(file.path(tax.vs.feat.module, "output/species/bigList_pvalues_fdr-adjusted_species.txt"))
